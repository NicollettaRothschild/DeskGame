...
const AGENT_WAKE_ALIASES =
  'arvis|arvison|arvisu|arvissu|arvis\'?s?|arvest|arviz|arvin|arvus|avis|armis|harvis|jarvis|airvis|arvos|arbus|harvest|ars|argos|argo|obis|orbis|arbes|arbeu|arvice|arviss|friend';
